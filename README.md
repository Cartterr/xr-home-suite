...
```bash
python -m xrhs run-probe --capture-count 3 --capture-every 2 --capture-width 960 -- --seconds 15 --no-depth --hand-hz 30
python -m xrhs run-probe --no-auto-captures -- --seconds 5 --no-depth --no-hands
